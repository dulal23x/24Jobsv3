...
export default function Home() {
  return (
    <div className="homepage-container">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl sm:text-4xl lg:text-6xl font-medium mb-4 text-gray-900 text-left">
                Unlock Your<br/>
            ...
            ?
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6 justify-center lg:justify-start">
                <Link href="/registration">
                  <button className="btn btn-primary btn-lg px-5 py-3 rounded-lg shadow-md transition-transform hover:translate-y-[-3px] text-xl font-semibold w-full sm:w-auto">
                    Join Now
                  </button>
                </Link>
      ...
      <section className='w-full py-10 md:py-16' style={{ background: 'linear-gradient(135deg, #415896 0%, #3b4e8c 100%)' }}>
        <div className="container mx-auto text-center text-white px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl mb-6 mx-auto max-w-xl">
              ...
              <div className="relative w-full max-w-md lg:max-w-lg h-[500px] flex items-center justify-center">
                ...
                <div className="relative z-10 bg-white rounded-xl shadow-xl p-4 sm:p-6 border border-gray-200 w-full max-w-xs sm:max-w-sm">
                  <div className="flex flex-col items-center">
                    <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Janice Smith" className="rounded-full object-cover mb-3 border-4 border-white shadow-md w-16 h-16 sm:w-20 sm:h-20" />
                    <div className="font-bold text-blue-700 text-lg sm:text-xl">Janice Smith</div>
                    <div className="font-semibold text-blue-900 mb-1 text-sm sm:text-base">Marketing Manager</div>
                    <div className="font-semibold text-blue-900 mb-2 text-sm sm:text-base">@ Elevate.co</div>
                    <div className="text-gray-700 mb-1 text-xs sm:text-sm">j.smith@elevate.co</div>
                    <div className="text-gray-700 mb-4 text-xs sm:text-sm">📞 841-440-5251</div>
                ...
                <div className="absolute z-0 top-0 left-0 transform -translate-x-1/4 -translate-y-1/4 rounded-lg shadow-md p-3 border bg-purple-50 w-40 sm:w-48">
                ...
                <div className="absolute z-0 top-0 right-0 transform translate-x-1/4 -translate-y-1/4 rounded-lg shadow-md p-3 flex items-center gap-2 border bg-green-50 w-44 sm:w-52">
                  <img src="https://randomuser.me/api/portraits/women/45.jpg" alt="Mina Kim" className="rounded-full object-cover w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0" />
                ...
                <div className="absolute z-0 bottom-0 right-0 transform translate-x-1/4 translate-y-1/4 rounded-lg shadow-md p-3 border bg-blue-50 w-48 sm:w-56">
      ...
      <section className="py-8 md:py-12 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-gray-600 font-semibold mb-6 md:mb-8 text-sm sm:text-base">
   ...
   {/* Data Quality Section */}
            ...
            <div className="relative flex-1 flex justify-center items-center w-full lg:w-1/2" style={{ minHeight: '450px' }}>
              ...
              <div className="relative z-10 bg-white rounded-xl shadow-lg flex flex-col sm:flex-row overflow-hidden w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto">
                ...
                <div className="bg-gray-50 w-full sm:w-40 p-4 border-b sm:border-b-0 sm:border-r flex flex-col gap-2">
                  ...
                  {/* Consider making this scrollable on small screens if too many items */}
                ...
                <div className="flex-grow p-4 flex flex-col gap-2">
                  <div className="flex flex-wrap gap-1 sm:gap-2 mb-2">
                    ...
                    <span className="badge rounded-full bg-blue-100 text-blue-700 text-xs flex items-center gap-1 px-2 py-0.5">
                      <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"> /* Adjusted size */
                  ...
                  {/* Placeholder for more profiles */}
                  <div className="bg-gray-100 rounded h-6 sm:h-8 opacity-60 my-1"></div> {/* Adjusted height */}
                  <div className="bg-gray-100 rounded h-6 sm:h-8 opacity-40"></div> {/* Adjusted height */}
                </div>
              </div>
            </div>
            {/* Right: Features */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 lg:gap-16">
            ...
            <div className="text-center relative md:pr-8 lg:pr-16 after:hidden md:after:block after:absolute after:right-0 after:top-1/2 after:-translate-y-1/2 after:h-12 after:w-px after:bg-white/30">
              ...
              <div className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-1 sm:mb-2">700M+</div> {/* Added + */}
              <div className="text-xs sm:text-sm opacity-80">Profiles</div>
            </div>
            {/* Stat 2: Million Companies */}
            <div className="text-center relative md:pr-8 lg:pr-16 after:hidden md:after:block after:absolute after:right-0 after:top-1/2 after:-translate-y-1/2 after:h-12 after:w-px after:bg-white/30">
              <div className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-1 sm:mb-2">60M+</div> {/* Added + */}
      ...
      {/* ================= CTA Section ================= */}
      <section className="cta-section-home py-10 md:py-16 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="container mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 mx-auto max-w-2xl">
          ...
          <div className="flex justify-center">
            <Link href="/registration">
              <button
                className="btn btn-primary btn-lg px-6 py-3 rounded-lg shadow-lg font-bold flex items-center gap-2 text-base sm:text-lg"
              >
                <svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
